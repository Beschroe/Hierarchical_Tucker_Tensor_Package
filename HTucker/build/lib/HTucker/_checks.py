...
def _check_U(U):
    """
        ...
        Prueft, ob 'U' ein gueltiges Blattmatrix-dict darstellt. Ist dies nicht der Fall, wird eine entsprechende
        Exception erzeugt.
        ______________________________________________________________________
        Parameter:
        - U dict mit (int,...):torch.Tensor Eintraegen: Das zu ueberpruefende Blattmatrix-dict
        ______________________________________________________________________
        Output:
        None
        """
...
def _check_B(B):
    """
        Hinweis: Dies ist eine interne Funktion.
        ______________________________________________________________________
        Prueft, ob 'B' ein gueltiges Transfertensor-dict darstellt. Ist dies nicht der Fall, wird eine entsprechende
        Exception erzeugt.
        ______________________________________________________________________
        Parameter:
        - B dict mit (int,...):torch.Tensor Eintraegen: Das zu ueberpruefende Transfertensor-dict
        ______________________________________________________________________
        Output:
        None
        """
...
def _check_compatibility(U, B, dtree):
    """
        Hinweis: Dies ist eine interne Funktion.
        ______________________________________________________________________
        Prueft, ob das Blattmatrix-dict 'U' und das Transfertensor-dict 'B' unter der im Dimensionsbaum 'dtree'
        hinterlegten Dimensionshierarchie kompatibel sind. Ist dies nicht der Fall, wird eine entsprechende Exception
        erzeugt.
        ______________________________________________________________________
        Parameter
        - U dict mit (int,...):torch.Tensor Eintraegen: Das zu ueberpruefende Blattmatrix-dict
        - B dict mit (int,...):torch.Tensor Eintraegen: Das zu ueberpruefende Transfertensor-dict
        - dtree dimtree: Der zu ueberpruefende Dimensionsbaum
        ______________________________________________________________________
        Output:
        None
        """
...
def _check_opts(opts):
    """
        ...
        ______________________________________________________________________
        Parameter:
        - opts dict mit str:float|int Eintraegen: Das zu ueberpruefende Options-dict.
        ______________________________________________________________________
        Output:
        None
        """
